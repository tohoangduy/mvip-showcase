...
public final class CameraManager {
  ...
  private static final int MAX_FRAME_WIDTH = 810;   // 1080 * 3/4;
  private static final int MAX_FRAME_HEIGHT = 1440; // 1920 * 3/4;
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      if (rotation == Surface.ROTATION_0) {
        //topOffset = (screenResolution.y - height) / 4; // for portrait mode, we need near the top
