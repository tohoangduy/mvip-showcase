...
public class TVRobotoLight extends AppCompatTextView {
    private static final String FONT_NAME = Const.FONT_ROBOTO_LIGHT;
    ...
    public TVRobotoLight(Context context, AttributeSet attrs, int defStyleAttr) {
