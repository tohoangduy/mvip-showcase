...
public class TVRobotoItalic extends AppCompatTextView {
    private static final String FONT_NAME = Const.FONT_ROBOTO_ITALIC;

    public TVRobotoItalic(Context context) {
        super(context);
        init();
    }

    public TVRobotoItalic(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TVRobotoItalic(Context context, AttributeSet attrs, int defStyleAttr) {
