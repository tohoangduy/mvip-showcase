...
public class TVRobotoBlack extends AppCompatTextView {
    private static final String FONT_NAME = Const.FONT_ROBOTO_BLACK;

    public TVRobotoBlack(Context context) {
        super(context);
        init();
    }

    public TVRobotoBlack(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TVRobotoBlack(Context context, AttributeSet attrs, int defStyleAttr) {
