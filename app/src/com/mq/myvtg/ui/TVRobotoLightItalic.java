...
public class TVRobotoLightItalic extends AppCompatTextView {
    private static final String FONT_NAME = Const.FONT_ROBOTO_LIGHTITALIC;
    ...
    public TVRobotoLightItalic(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TVRobotoLightItalic(Context context, AttributeSet attrs, int defStyleAttr) {
