...
public class RequestParams implements Serializable {
    ...
    final static String APPLICATION_OCTET_STREAM =
            "application/octet-stream";

    final static String APPLICATION_JSON =
            "application/json";

    protected final static String LOG_TAG = "RequestParams";
    private boolean isRepeatable;
    private boolean forceMultipartEntity = false;
    private boolean useJsonStreamer;
    private String elapsedFieldInJsonStreamer = "_elapsed";
    ...
    private final ConcurrentHashMap<String, StreamWrapper> streamParams = new ConcurrentHashMap<String, StreamWrapper>();
    private final ConcurrentHashMap<String, FileWrapper> fileParams = new ConcurrentHashMap<String, FileWrapper>();
    private final ConcurrentHashMap<String, List<FileWrapper>> fileArrayParams = new ConcurrentHashMap<String, List<FileWrapper>>();
    private final ConcurrentHashMap<String, Object> urlParamsWithObjects = new ConcurrentHashMap<String, Object>();
